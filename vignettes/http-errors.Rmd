---
title: "Commom HTTP errors in the Figma API"
author: Pedro Duarte Faria
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Commom HTTP errors in the Figma API}
...
When you use `figma::get_figma_page()`, and it returns an HTT error with status code 400,
