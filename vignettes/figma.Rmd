...
However, if you want to use `get_figma_objects()`, you will need to collect a third information,
...
This also means that, if you want to use `get_figma_objects()`, you will need
